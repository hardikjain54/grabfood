...
class Driver: 
    def __init__(self, driver_path: str = "C:\Users\Hardik jain\Downloads\Chromedriver.exe") -> None:
...
if __name__ == "__main__":
    driver_path = "C:\Users\Hardik jain\Downloads\Chromedriver.exe"  # path to the chromedriver
